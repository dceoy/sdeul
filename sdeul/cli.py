...
def extract(
    ...
    ollama_keep_alive: str | None = typer.Option(
        ...
        help="Duration to keep Ollama model loaded (e.g., '5m', '10m', or -1 for indefinite).",
    ),
    ...
    Args:
        ...
        ollama_keep_alive (str | None): Duration to keep Ollama model loaded
            in memory (e.g., "5m", "10m", or -1 for indefinite).
