...
def create_llm_instance(
    ...
    Args:
        ...
        ollama_keep_alive (str | int | None): Controls how long Ollama keeps
            the model loaded in memory. Can be a duration string (e.g., "5m",
            "10m") or an integer (seconds). None uses Ollama's default.
