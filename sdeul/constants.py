...
- **Context Awareness**: If domain-specific context or terminology definitions are provided, apply them when interpreting the input text
...
# Process
1. Identify the domain context from the schema and any provided terminology
...
# Domain Adaptation
- If terminology definitions or domain context are provided, prioritize those interpretations
